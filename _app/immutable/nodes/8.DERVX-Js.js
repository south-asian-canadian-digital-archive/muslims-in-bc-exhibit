import{h as N}from"../chunks/DbXlyHq8.js";import{a as w,f as y}from"../chunks/BMHC7EQW.js";import{i as U}from"../chunks/Cs4ZeMFf.js";import{aa as q,K as b,a1 as G,p as V,s as e,c as m,r as h,t as j,X as O,a as z,b as K,f as F,$ as J}from"../chunks/BfzmKt89.js";import{h as W}from"../chunks/BEwQXuRP.js";import{i as S}from"../chunks/KJaBexMX.js";import{h as L,s}from"../chunks/C2LEDEc4.js";import{b as B}from"../chunks/Oj5SJ-UZ.js";import{p as X}from"../chunks/B6hz6O2u.js";import{s as Q}from"../chunks/DKZYBOp2.js";import{e as Y,i as Z}from"../chunks/DeUlQhEb.js";import{I as E,H as ee}from"../chunks/sFkti638.js";import{P as I}from"../chunks/DmaGj8bs.js";function ae(r){var a=G(0);return function(){return arguments.length===1?(q(a,b(a)+1),arguments[0]):(b(a),r())}}const ie=()=>N,te=!0,ne="always",Pe=Object.freeze(Object.defineProperty({__proto__:null,entries:ie,prerender:te,trailingSlash:ne},Symbol.toStringTag,{value:"Module"}));let oe=[{img:"/content/2021_08_01_041.jpg",name:"Husain Rahim",years:"(1865-1937)",desc:` 
     ...
     `},{img:"",name:"Imanat Ali Khan",years:"(1887-?)",desc:`
        ...
        <li>Husain, Iqbal. “BARKATULLAH — A HALF-FORGOTTEN REVOLUTIONARY.”
            ...
            <br> <a href="${B}/resources/themuslimvibe.pdf" target="_blank">(archived pdf version here)</a>
        </li>
    ...
    `},{img:"",name:"Muhammad Akbar",years:"-",desc:`
     ...
     `}];var se=y("<section><h2> </h2> <div><!> <!></div></section>"),re=y(`<main class="py-32 flex flex-col gap-10"><h1 class="px-4 lg:px-0 page-title">Case Studies: Hidden Histories</h1> <p class="desc-text">Due to the lack of archives, we find only small traces of early South Asian muslim
    ...
    English Militarism".</p> <div class="flex flex-col gap-16 *:w-full history"></div></main>`);function le(r,a){V(a,!1),U();var n=re(),l=e(m(n),4);Y(l,5,()=>oe,Z,(d,o,M)=>{var p=se(),A=m(p),i=m(A);h(A);var v=e(A,2),f=m(v);{var k=u=>{E(u,{get src(){return b(o).img},get alt(){return`Image depicting ${b(o).name??""}`},class:"w-[30vw]",float:"right"})};S(f,u=>{b(o).img&&u(k)})}var c=e(f,2);L(c,()=>b(o).desc),h(v),h(p),j(u=>{s(p,"id",u),Q(i,`Case Study ${M+1}: ${b(o).name??""}
          ${b(o).years??""}`)},[()=>b(o).name.toLowerCase().split(" ").join("-")],O),w(d,p)}),h(l),h(n),w(r,n),z()}var he=y('<a href="https://www.newspapers.com/image/490371705/">https://www.newspapers.com/image/490371705/</a> <br/> Vancouver Sun, Sept 24th 1922, p. 35',1),me=y(`<main class="py-32 flex flex-col gap-10"><h1 class="px-4 lg:px-0 page-title">Early 20<sup>th</sup> Century Migration</h1> <div class="flex flex-col gap-16 *:w-full history"><section><h2>Snippets and Partial Stories</h2> <div><!> In the early years one of the only ways it is possible to tell whether
        ...
        on Rahim can be found under the section on <a>Case Studies: Hidden Histories.</a> <div class="flex flex-row"></div></div></section></div></main>`);function ce(r){var a=me(),n=e(m(a),2),l=m(n),d=e(m(l),2),o=m(d);E(o,{src:"/content/new/newspaper_clipping2.png",alt:"newspaper clipping",class:"w-1/2",float:"right"});var M=e(o,2),p=e(M,5);E(p,{src:"/content/new/newspaper_clipping.png",alt:"newspaper clipping",class:"w-1/2",float:"left",children:(i,v)=>{var f=he();K(3),w(i,f)},$$slots:{default:!0}});var A=e(p,8);K(2),h(d),h(l),h(n),h(a),j(()=>{s(M,"href",`${B??""}/history/case-studies`),s(A,"href",`${B??""}/history/case-studies#husain-rahim`)}),w(r,a)}var de=y(`<main class="py-32 flex flex-col gap-10 mx-auto"><h1 class="px-4 lg:px-0 page-title">Mid 20th century migration <span class="whitespace-nowrap">(1962-2001)</span></h1> <div class="flex flex-col gap-16 history"><section><h2>Muslim Identity as National and Transnational</h2> <div>Muslims of South Asian descent came to British Columbia from many
        ...
        merge influences from different regions. <br/><br/> Many South Asian Muslim in British Columbia trace their roots to Punjab,
        ...
        sharing such an identity rooted in their business and trade links. See <a href="#">X</a> <br/><br/> Simultaneously, other groups of South Asian Muslims were sent with other
        ...
        Asians from the country (see 1972 in <a>Historical Timeline</a>). The
        ...
        blend South Asian, African and Canadian traditions. <br/><br/> As a result, the South Asian Muslim experience in British Columbia is
        ...
        be Canadian.</div></section></div></main>`);function ue(r){var a=de(),n=e(m(a),2),l=m(n),d=e(m(l),2),o=e(m(d),9);K(16),h(d),h(l),h(n),h(a),j(()=>s(o,"href",`${B??""}/history/recent-timeline`)),w(r,a)}var pe=y(`<main class="py-32 mx-auto flex flex-col gap-10"><h1 class="px-4 lg:px-0 page-title">Recent experiences of South Asian Muslim in BC (2001 - present)</h1> <div class="flex flex-col gap-16 history"><section><h2>Canada and South Asian Canadian Muslims after 9/11</h2> <div>The attacks on the twin towers on the 11th of September 2011, and
        ...
        communities of B.C. <a href="https://www.islamichistorymonth.ca/indigenous-muslims"><sup>[*]</sup></a></div></section> <section><h2>Muslim Women</h2> <div>Muslims in British Columbia can choose to be part of a thriving
        ...
        less spaces available to them to congregate. <br/><br/> Similarly, younger members of the Muslim community in BC have not always
        ...
        narrative.</div> <iframe title="Recent Timeline of Muslims In British Columbia" src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=v2:2PACX-1vQq6XreVNJadGkn2skgHj7GBWJhdau9JJso43eaEQsU0DNecwrv7iJ-gYM-5Bz18OTA0KyCqLh62ktE&amp;font=Default&amp;lang=en&amp;initial_zoom=0&amp;height=800" width="100%" height="800" allowfullscreen="" frameborder="0"></iframe></section></div></main>`);function be(r){var a=ge();w(r,a)}var t=ae(()=>X),we=y('<meta name="description"/> <meta name="keywords"/> <meta name="author" content="South Asian Studies Institute, University of the Fraser Valley"/> <meta property="og:type" content="article"/> <meta property="og:title"/> <meta property="og:description"/> <meta property="og:image"/> <meta property="og:url"/> <meta property="og:site_name" content="South Asian Muslims in BC"/> <meta name="twitter:card" content="summary_large_image"/> <meta name="twitter:title"/> <meta name="twitter:description"/> <meta name="twitter:image"/> <link rel="canonical"/> <!>',1),ye=y("<!> <!>",1);function je(r,a){V(a,!1);const n=t().params.id.split("-").map(i=>`${i[0].toUpperCase()}${i.slice(1)}`).join(" "),l=i=>{switch(i){case"early-20th-century":return"Explore the early migration patterns and settlement experiences of South Asian Muslims in British Columbia during the early 20th century, including challenges faced and communities established.";case"mid-20th-century":return"Discover the mid-20th century experiences of South Asian Muslim communities in BC, including policy changes, community growth, and cultural preservation efforts.";case"recent-experiences":return"Learn about contemporary experiences of South Asian Muslims in British Columbia, including modern community development, religious practices, and cultural integration.";case"timeline":return"Browse an interactive timeline of significant events in South Asian Muslim history in British Columbia, from early settlement to present day milestones.";case"case-studies":return"Examine detailed case studies highlighting specific experiences, challenges, and achievements of South Asian Muslim individuals and families in BC.";default:return"Explore the historical journey of South Asian Muslims in British Columbia through detailed period studies and community stories."}};U();var d=ye();W(i=>{var v=we(),f=F(v),k=e(f,2),c=e(k,6),u=e(c,2),_=e(u,2),H=e(_,2),g=e(H,6),T=e(g,2),R=e(T,2),P=e(R,2),C=e(P,2);L(C,()=>`<script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Article",
      "headline": "${n} - South Asian Muslims in BC",
      "description": "${l(t().params.id)}",
      "url": "https://${I}/history/${t().params.id}",
  ...
  <\/script>`),j((D,$,x)=>{J.title=`${n??""} | Historical Journey - South Asian Muslims in BC`,s(f,"content",D),s(k,"content",`South Asian Muslim history, ${n??""}, BC immigration, Muslim community ${t().params.id??""}, historical timeline, community development, British Columbia Muslims`),s(c,"content",`${n??""} | Historical Journey - South Asian Muslims in BC`),s(u,"content",$),s(_,"content",`${B??""}/content/2021_08_01_040.jpg`),s(H,"content",`https://${I??""}/history/${t().params.id??""}`),s(g,"content",`${n??""} | Historical Journey - South Asian Muslims in BC`),s(T,"content",x),s(R,"content",`${B??""}/content/2021_08_01_040.jpg`),s(P,"href",`https://${I??""}/history/${t().params.id??""}`)},[()=>l(t().params.id),()=>l(t().params.id),()=>l(t().params.id)],O),w(i,v)});var o=F(d);{var M=i=>{ce(i)},p=(i,v)=>{{var f=c=>{ue(c)},k=(c,u)=>{{var _=g=>{fe(g)},H=(g,T)=>{{var R=C=>{be(C)},P=(C,D)=>{{var $=x=>{le(x,{})};S(C,x=>{t().params.id==="case-studies"&&x($)},D)}};S(g,C=>{t().params.id==="timeline"?C(R):C(P,!1)},T)}};S(c,g=>{t().params.id==="recent-experiences"?g(_):g(H,!1)},u)}};S(i,c=>{t().params.id==="mid-20th-century"?c(f):c(k,!1)},v)}};S(o,i=>{t().params.id==="early-20th-century"?i(M):i(p,!1)})}var A=e(o,2);ee(A,{get currentId(){return t().params.id},set currentId(i){t(t().params.id=i)},$$legacy:!0}),w(r,d),z()}export{je as component,Pe as universal};
