...
export const interviews: Interview[] = [
  {
    ...
    thumbnailUrl: `${base}/content/placeholder-interview.jpg`,
    ...
    images: [
      { url: `${base}/content/placeholder-1.jpg`, alt: "Abdul in his community center" },
      { url: `${base}/content/placeholder-2.jpg`, alt: "Historic photo of Vancouver's first mosque" },
      { url: `${base}/content/placeholder-3.jpg`, alt: "Community celebration" }
    ],
    additionalInfo: [
      {
  ...
  },
  {
    ...
    images: [
      { url: `${base}/content/placeholder-1.jpg`, alt: "Amina speaking at community event" },
      { url: `${base}/content/placeholder-2.jpg`, alt: "Women's education program" },
      { url: `${base}/content/placeholder-3.jpg`, alt: "Interfaith dialogue session" }
    ],
    additionalInfo: [
      {
  ...
  },
  {
    ...
    images: [
      { url: `${base}/content/placeholder-1.jpg`, alt: "Yusuf in his restaurant" },
      { url: `${base}/content/placeholder-2.jpg`, alt: "Original restaurant location from 1993" },
      { url: `${base}/content/placeholder-3.jpg`, alt: "Family celebration" }
    ],
    additionalInfo: [
      {
  ...
  },
  {
    ...
    images: [
      { url: `${base}/content/placeholder-1.jpg`, alt: "Fatima at medical conference" },
      { url: `${base}/content/placeholder-2.jpg`, alt: "Community health workshop" },
      { url: `${base}/content/placeholder-3.jpg`, alt: "Family photo" }
    ]
  }
];
