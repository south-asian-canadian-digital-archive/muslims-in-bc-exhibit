...
<svelte:head>
  <title
    >{personality.name} - Contemporary Personality | South Asian Canadian Muslims in BC</title
  >
  <meta
    name="description"
  ...
  <meta
    property="og:title"
    content="{personality.name} - Contemporary Personality | South Asian Canadian Muslims in BC"
  />
  <meta
